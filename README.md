...
This first .gif here shows having a duplicated object 2118 (points) several times. My fps is consistently maxed at 240. Before using the webgl canvas only 3 of the 2118 objects would cause lag. Now I have here around 12x as many with no lag.
